...
class ValidationService {
  ...
  static Future<ValidationResult> validateDatabaseIntegrity() async {
    ...
    try {
      ...
      final orphanedReports = await db.rawQuery('''
        SELECT COUNT(*) as count FROM ${DatabaseService._healthReportsTable} hr
        LEFT JOIN ${DatabaseService._usersTable} u ON hr.user_id = u.id
        WHERE u.id IS NULL
      ''');
      ...
      final inconsistentReports = await db.rawQuery('''
        SELECT COUNT(*) as count FROM ${DatabaseService._healthReportsTable}
      ...
      final missingDistricts = await db.rawQuery('''
        SELECT COUNT(*) as count FROM ${DatabaseService._healthReportsTable} hr
        LEFT JOIN ${DatabaseService._districtsTable} d ON hr.district_id = d.id
  ...
  static Future<ValidationResult> validateDataForSync(String tableName, String recordId) async {
    ...
    try {
      ...
      switch (tableName) {
        case DatabaseService._usersTable:
        ...
        case DatabaseService._healthReportsTable:
        ...
        case DatabaseService._districtsTable:
