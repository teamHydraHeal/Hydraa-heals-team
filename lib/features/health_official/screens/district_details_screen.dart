...
class _DistrictDetailsScreenState extends State<DistrictDetailsScreen> {
    ...
    switch (districtId) {
      case 'east_khasi_hills':
        return District(
          ...
          affectedBlocks: ['Shillong', 'Mawryngkneng', 'Pynursla'],
        );
      case 'ri_bhoi':
        return District(
          id: 'ri_bhoi',
          ...
          affectedBlocks: ['Nongpoh', 'Umsning', 'Jirang'],
        );
      default:
        return District(
          id: districtId,
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // IoT Data
            IotDataWidget(iotData: _district!.iotData),
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: _getRiskColor(_district!.riskLevel).withOpacity(0.1),
  ...
  Widget _buildAffectedBlocks() {
    if (_district!.affectedBlocks.isEmpty) {
        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              spacing: 8,
              runSpacing: 8,
              children: _district!.affectedBlocks.map((block) {
                return Container(
